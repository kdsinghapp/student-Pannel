...
import {getCountryList,getReligionsList,getAllClasses} from "../../utils/authApi";
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div clasNames="d-flex mb-2" >
              <div className="mr-3" onClick={handleImageClick} style={{ cursor: "pointer" }}>
                  <img src={editFormData?.profile_image} style={{ width:"10em" ,height:"10em", borderRadius:"50%"}}/>
                  <input
                    type="file"
                    ref={fileInputRef}
                    style={{ display: "none" }}
              ...
              <div>
                  <h6 className="mb-0 mt-2">{editFormData?.first_name} {editFormData?.last_name}</h6>
                  <p>Student Code: <span>5452</span></p>
              </div>
            </div>
...
export default EditStudent;
 ...
 const EditStudentUI = ({ selectedStudent, handleUpdate, countries, religions,classData }) => {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="d-flex mb-2">
            <div className="mr-3" onClick={() => fileInputRef.current.click()} style={{ cursor: "pointer" }}>
              <img
                src={
            ...
            <div>
              <h6 className="mb-0 mt-2">{selectedStudent?.first_name} {selectedStudent?.last_name}</h6>
              <p>Student Code: <span>5452</span></p>
            </div>
          </div>
