    ...
    const fetchData = async () => {
      try {
        ...
        const [depRes, roleRes, classRes] = await Promise.all([
          ...
          axios.get(
            `${API_URL}/user/classes/get-class-hierarchy?school_curriculum_id=${localStorage.getItem(
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${API_URL}/user/teacher/update-teacher`,
        formData,
        {
          headers: {
      ...
      <div className="row">
        ...
        <div className="col-xl-6 col-lg-6 col-12 form-group">
          ...
          {errors.year_group_id && (
            <p className="text-danger">{errors.year_group_id.message}</p>
          )}
        </div>
        {/* Department */}
        <div className="col-xl-6 col-lg-6 col-12 form-group">
        ...
        <div className="col-xl-6 col-lg-6 col-12 form-group">
          ...
          <select
            className="form-control"
            {...register("teacher_role_id", { required: "Role is required" })}
          >
          ...
          {errors.teacher_role_id && (
            <p className="text-danger">{errors.teacher_role_id.message}</p>
          )}
        </div>
        {/* Assigned Classes */}
        <div className="col-xl-6 col-lg-6 col-12 form-group">
          ...
          />
          {selectError.classes && isSubmitted && (
            <p className="text-danger">At least one class is required</p>
          )}
        </div>
        {/* Assigned Subjects */}
        <div className="col-xl-6 col-lg-6 col-12 form-group">
          ...
          />
          {selectError.subjects && isSubmitted && (
